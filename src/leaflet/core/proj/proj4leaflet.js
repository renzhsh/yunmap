...
/**
 * API 参考
 * http://npm.taobao.org/package/proj4leaflet
 */
Proj._isProj4Obj = function(a) {
    return typeof a.inverse !== "undefined" && typeof a.forward !== "undefined";
};

Proj.Projection = L.Class.extend({
    initialize: function(code, def, bounds) {
        var isP4 = Proj._isProj4Obj(code);
    ...
    addData: function(geojson) {
        ...
        if (geojson) {
            if (geojson.crs && geojson.crs.type === "name") {
                crs = new Proj.CRS(geojson.crs.properties.name);
...
Proj.geoJson = function(geojson, options) {
    return new Proj.GeoJSON(geojson, options);
};

Proj.ImageOverlay = L.ImageOverlay.extend({
    ...
    _reset: function() {
        ...
        var bounds = L.bounds(
            ...
            this._transform(this._projectedBounds.max, zoom)._subtract(
                pixelOrigin
            )
        );
...
Proj.imageOverlay = function(url, bounds, options) {
    return new Proj.ImageOverlay(url, bounds, options);
};
